...
class OthersCustomerPage extends StatefulWidget {
  const OthersCustomerPage({super.key});

  @override
  State<OthersCustomerPage> createState() => _OthersCustomerPageState();
}

class _OthersCustomerPageState extends State<OthersCustomerPage> {
  int currentIndex = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            // FIX: Changed isEqualTo from "Other" to "Others" to match
            // the value saved by OthersAdminPage
            StreamBuilder(
