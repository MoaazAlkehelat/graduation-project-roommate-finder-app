...
class HomeFoodCustomerPage extends StatefulWidget {
  const HomeFoodCustomerPage({super.key});

  @override
  State<HomeFoodCustomerPage> createState() => _HomeFoodCustomerPageState();
}

class _HomeFoodCustomerPageState extends State<HomeFoodCustomerPage> {
  int currentIndex = 1;
