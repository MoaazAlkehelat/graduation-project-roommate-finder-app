...
class PostRoommatePage extends StatefulWidget {
  final Map<String, dynamic>? postData;
  final int? postIndex;
  // FIX: added postDocId for Firestore document updates (edit mode)
  final String? postDocId;

  const PostRoommatePage({super.key, this.postData, this.postIndex, this.postDocId});

  @override
  State<PostRoommatePage> createState() => _PostRoommatePageState();
}

class _PostRoommatePageState extends State<PostRoommatePage> {
                    ...
                    child: Center(
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(AppStrings.postRoommate(lang), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
                        ],
                      ),
                    ),
                  ),
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: Text(AppStrings.postAccommodation(lang), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
